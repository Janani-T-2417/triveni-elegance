      ...
      <section className="relative overflow-hidden bg-gradient-hero">
        ...
        <div className="container-px mx-auto max-w-7xl py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="mt-6 font-display text-5xl sm:text-6xl md:text-7xl leading-[1.05] tracking-tight text-balance">
              Premium Quality <span className="italic text-sage-deep">Rice, Dals</span> &amp; <span className="italic text-gold-deep">Cashews</span>
            </h1>
